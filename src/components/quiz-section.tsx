              ...
              <div className="flex flex-col gap-4">
                {currentQuestion.options?.map((option) => (
                  <Button
                    ...
                    variant="outline"
                    size="lg"
                    className="w-full text-lg py-4 border-primary/30 bg-transparent hover:bg-primary/20 hover:text-white transition-all duration-200 whitespace-normal h-auto"
                  >
                    {option}
                  </Button>
                ))}
